	 		...
	 		[ 
	 			{
	 				...
	 				contenu:"<p> On compte deux types d'aides à l'enfance versées par la Caisse d'Allocations Familiales, et quatre versées par le Département.</p>" +
	 						"<h3> La prestation d'accueil du jeune enfant (PAJE)</h3>" + 
	 						"<p> La PAJE est une aide financière versée aux parents jusqu’aux 3 ans de l’enfant (6 ans pour le complément de libre choix du mode de garde). Elle comprend une prime à la naissance (ou à l'adoption) et l’allocation de base, la prestation partagée d'éducation de l'enfant ou le complément de libre choix d’activité si vous ou l’autre parent réduisez votre temps de travail ou arrêtez de travailler pour garder votre enfant, ainsi que le complément de libre choix du mode de garde, si vous choisissez de faire garder votre enfant par une assistante maternelle agréée, une garde d’enfants à domicile, une association, une entreprise ou une micro-crèche.</p>" +
         					"<h3> L'Allocation d'Education de l'Enfant Handicapé (AEEH)</h3>" +
         					"<p>L’AEEH est une prestation destinée à compenser les frais d'éducation et de soins apportés à un enfant en situation de handicap. Cette aide est versée à la personne qui en assume la charge.</p>" +
         					"<h3> Les aides à l'enfance du département </h3>" +
         					"<p><i>L' Allocation Mensuelle (AM)</i> <br>Aide financière ponctuelle accordée au titre de la protection de l’enfance lorsqu’une famille ne dispose pas de ressources suffisantes pour subvenir aux besoins courants de ses enfants.</p>" +
         					"<p><i>Les aides Secours d'Urgence (SU) </i> <br>Aide financière d'urgence, pour répondre à une difficulté lorsque la santé de l'enfant, sa sécurité, son entretien ou son éducation le nécessitent. Le versement urgent doit être justifié.</p>" +
         					"<p><i>Fonds d'Aide aux Jeunes (FAJ) </i> <br>Aides destinées à favoriser l'insertion sociale et professionnelle des 18-25 ans en leur apportant des secours temporaires sous la forme d'aides financières ou de prestations d'accompagnement social.Il s'agit d'aides ponctuelles et de faible montant qui doivent répondre à un besoin précis (logement, travail, transport...).</p>" +
         					"<p><i>Fonds d'Aide aux Jeunes d'Urgence (FAJU) </i> <br>Similaire au FAJ, mais pouvant être versé immédiatement.</p>",
				},
				{
					soustitre:"Les aides à l'insertion",
					contenu:"<h3> Le Revenu de Solidarité Active (RSA) </h3>" + 
							"<p> Il s'agit d'une allocation qui vise à remplacer les deux minimas sociaux existants (RMI et API), à se substituer à des dispositifs d'intéressement de retour à l'emploi comme la prime de retour à l'emploi (PRE) et la prime pour l'emploi (PPE). Son montant dépend de la composition et des revenus du ménage. Il se décline en trois types : RSA Socle, RSA Socle Activité, et RSA Activité. Ici, les données présentent une aggrégation de ces trois types.</p>" +
				...
				},
				{
					...
					contenu:"<h3> L'Allocation Personnalisée d'Autonomie (APA) </h3>" + 
					    	"<p> L'APA est une allocation attribuée aux personnes âgées d'au moins 60 ans qui se trouvent en situation de perte d'autonomie, nécessitant une aide pour l'accomplissement des actes de la vie courante. Elle concerne à la fois les personnes âgées résidant à domicile et celles demeurant en établissement.</p>" +
					    	"<p><i>Les Groupes Iso-Ressources (GIR)</i> <br>Ils permettent de classer les personnes en fonction des différents stades de perte d'autonomie. Ils sont au nombre de 6, le groupe 1 marque le niveau de dépendance le plus élevé. Les GIR 5 et 6 n'entrent pas dans le champ de l'APA.</p>" +       
         					"<h3> Prestation de Compensation du Handicap (PCH)</h3>" + 
         					"<p>La PCH est une aide financière versée par le département. Elle est destinée à rembourser les dépenses liées à votre perte d'autonomie. Son attribution dépend de votre degré d'autonomie, de votre âge, de vos ressources et de votre résidence.</p>" +
        					"<h3> Le minimum veillesse </h3>" +
        					"<p>Le minimum vieillesse (appelée depuis 2005 Allocation de solidarité aux personnes âgées ou ASPA) est une prestation sociale française versée sans contrepartie de cotisation, créée en 1956. Son objectif est d'apporter un complément de ressources pour porter au niveau du minimum vieillesse les revenus des personnes âgées disposant de faibles moyens d'existence. Constitué de différentes allocations, il a été simplifié en 2006 en une prestation unique, l'allocation de solidarité aux personnes âgées (ASPA), mais ses différentes allocations persistent pour les personnes qui ont commencé à en bénéficier avant 2006.</p>",				
     		},
		],
		sources: [
			{
	...
	},
	{
		titre: "Lieux de Résidence",
	 	span:[
	 		{	
	 			soustitre:"Définitions",
	 			contenu:" <h3>Résidences principales</h3>"+
	 					"<p> Une résidence principale est un logement occupé de façon habituelle et à titre principal par une ou plusieurs personnes.</p>"+
	 					"<h3>Le parc public</h3>"+
	 					"<p>Chaque année, l'Insee réalise, en partenariat avec le SDES, un travail de synthèse et de mise en cohérence de plusieurs sources, pour chiffrer le parc public des logements ordinaires et le décrire en fonction de la catégorie de logement (résidence principale, résidence secondaire ou logement occasionnel, logement vacant), le type d'habitat (collectif, individuel), le statut d'occupation (ou la filière) et la zone géographique (par taille d'unité urbaine).</p>"+
	 					"<h3>Les EPHAD</h3>"+
	 					"<p>Les EHPAD (établissements d’hébergement pour personnes âgées dépendantes) sont des maisons de retraite médicalisées qui proposent un accueil en chambre. Les EHPAD s’adressent à des personnes âgées de plus de 60 ans qui ont besoin d’aide et de soins au quotidien.</p>",
				},
			],
		sources:[	
			{
		...
		titre: "Les établissements scolaires",
	 	span:[
	 		{	
	 			...
	 			contenu:"<p>Sont recensés ici tous les établissements scolaires, qu'ils soient publics ou privés.</p>"+
	 				"<h3> Les écoles du 1er degré</h3>"+
	 				"<p> </p>"+
         			"<p><i>Les écoles maternelles</i> <br>L'école maternelle peut accueillir les enfants avant l'instruction obligatoire qui débute à 6 ans. Il s'agit d'une originalité du système français. Elle est le plus souvent organisée en petite, moyenne et grande section, en fonction de l'âge des enfants. Les locaux des écoles appartiennent aux communes qui ont la charge de leur entretien. </p><p><i>Les école élémentaires</i> <br>L'école élémentaire accueille les enfants scolarisés de 6 à 11 ans. Elle est mixte et gratuite si elle est publique. Elle comporte deux cycles : le cycle 2 (CP, CE1, CE2) et le cycle 3 (CM1 et CM2). Les locaux des écoles appartiennent aux communes qui ont la charge de leur entretien.</p>"+
         			"<h3> Les collèges</h3>"+
         			"<p>Le collège est l'établissement de niveau secondaire qui, à l'issue de l'école élémentaire, accueille tous les enfants scolarisés. Ils y suivent quatre années de scolarité de la sixième à la troisième. Les collèges publics sont des établissements publics locaux d'enseignement (EPLE). Ils définissent et mettent en œuvre un projet d'établissement, qui leur permet de prendre des initiatives et d'être autonomes. La gestion de leurs bâtiments relève des départements en application des lois de décentralisation.</p>",
				},
			],
		sources:[	
			{
